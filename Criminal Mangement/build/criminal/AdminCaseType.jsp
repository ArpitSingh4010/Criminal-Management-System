...
<head>
    ...
    <title>Manage Case Types - Admin Panel | Criminal Management System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="breadcrumb">
        <div class="breadcrumb-content">
            <a href="AdminHome.jsp">Admin Home</a> / Manage Case Types
        </div>
    </div>
    ...
    <div class="container">
        ...
        <% 
            ...
            if (error != null) {
                ...
                if ("add_failed".equals(error)) {
                    message = "❌ Failed to add case type. Please try again.";
                } else if ("update_failed".equals(error)) {
                    message = "❌ Failed to update case type. Please try again.";
                } else if ("delete_failed".equals(error)) {
                    message = "❌ Failed to delete case type. Please try again.";
                }
                if (!message.isEmpty()) {
        %>
        ...
        <div class="page-header">
            <div class="page-header-text">
                ...
                <p>Add, edit, or delete criminal case categories as per Indian Penal Code</p>
            </div>
            <a href="AdminCaseTypeForm.jsp" class="btn-add-new">➕ Add New Case Type</a>
        </div>
        ...
        <div class="case-grid" id="caseGrid">
            ...
            <div class="case-card" data-name="<%= ct.getCaseType().toLowerCase() %>" 
                ...
                <div class="card-actions">
                    <a href="AdminCaseType?action=edit&id=<%= ct.getTypeId() %>" class="btn-edit">✏️ Edit</a>
                    <a href="AdminCaseType?action=delete&id=<%= ct.getTypeId() %>" 
                       class="btn-delete" 
                       onclick="return confirm('Are you sure you want to delete this case type?')">🗑️ Delete</a>
                </div>
            </div>
            <%
                    }
            ...
            <div class="no-results">
                ...
                <p>Click "Add New Case Type" to create your first case type</p>
            </div>
            <%
                }
            %>
